...
uint32_t image_Width[] = {100,350,630,890,1200,1500,1920};
uint32_t image_Height[] = {100,300,550,800,1100,1300,1080};
/* USER CODE END PV */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  for (uint32_t i = 0; i< x ;i++){
		  volatile uint16_t width = image_Width[i];
		  volatile uint16_t height = image_Height[i];
